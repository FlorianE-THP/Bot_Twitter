...
def five_tweet(journalist)
  client = login_twitter
  5.times { client.update("Bonjour #{journalist.sample}, j'adore ton travail !")}
end
...
def follow_bonjour 
  client = login_twitter
  client.search("#macron").take(11).each do |tweet|
...
def stream 
  client = login_twitter_streaming
